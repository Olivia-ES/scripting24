...
document.getElementById("column2").innerHTML = "I Have Been Changed (I=column2)";
document.getElementById("column2").style.backgroundColor = "blue";
document.getElementById("column2").style.color = "pink";
document.getElementById("column2").style.textAlign = "right";
document.getElementById("column2").style.fontSize = "40px";
